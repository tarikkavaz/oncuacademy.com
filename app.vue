<template>
  ...
  <!-- Left -->
  <div class="relative px-6 py-24 overflow-hidden bg-white isolate sm:py-32 lg:overflow-visible lg:px-0" id="section-left">
      ...
      <div class="lg:col-span-2 lg:col-start-2 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-1 lg:gap-x-8 lg:px-8">
        <div class="lg:pr-4">
          <div class="lg:max-w-lg">
            ...
            <p class="mt-6 text-base leading-8 text-gray-700">Through our innovative programs, modules, and courses, we seek to pioneer new frontiers in learning, equipping individuals, professionals, organizations, and communities with the knowledge and skills they need to achieve their goals. By fostering a culture of lifelong learning, we aim to create positive change and make a lasting impact on the world.</p>
          </div>
        </div>
      </div>
          ...
          <div class="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
            <ul role="list" class="mt-8 space-y-8 text-gray-600">
              <li class="flex gap-x-3">
                ...
                <span><strong class="font-semibold text-gray-900">Vision.</strong>
              ...
              <li class="flex gap-x-3">
                <LightBulbIcon class="flex-none w-5 h-5 mt-1 text-oncured-600" aria-hidden="true" />
                <span><strong class="font-semibold text-gray-900">Knowledge Creation and Sharing</strong>
              ...
              <li class="flex gap-x-3">
                <AcademicCapIcon class="flex-none w-5 h-5 mt-1 text-oncured-600" aria-hidden="true" />
              ...
              <li class="flex gap-x-3">
                ...
                <span><strong class="font-semibold text-gray-900">Who can benefit from Öncü Academy's learning programs?</strong>
                  <ul>
