          ...
          <div class="lg:col-span-2 lg:col-start-2 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-1 lg:gap-x-8 lg:px-8">
            <div class="lg:pr-4">
              <div class="lg:max-w-lg">
                <div
                  data-tf-widget="bi7RWIqU"
                  data-tf-opacity="100"
                  data-tf-inline-on-mobile
                  data-tf-iframe-props="title=oncuacademy"
        ...
        <div class="grid max-w-2xl grid-cols-1 mx-auto gap-y-16 gap-x-8 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
          <div class="lg:col-span-2 lg:col-start-2 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-1 lg:gap-x-8 lg:px-8">
            <div class="lg:pr-4">
              <div class="lg:max-w-lg">
                <div
                  data-tf-widget="DPdMPgND"
                  data-tf-opacity="100"
                  data-tf-inline-on-mobile
                  data-tf-iframe-props="title=oncuacademy (en)"
                  data-tf-transitive-search-params
                  data-tf-auto-focus
                  data-tf-medium="snippet"
                  data-tf-full-screen
...
<script>
export default {
  name: 'AppclicationForm',
  data () {
    return {
      showModal: false,
      headTitle: this.$t('form') + ' | ' + this.$t('title'),
      headerTitle: '',
      headerParagraph: '',
      headerImage: ''
    }
    ...
    updateHeader () {
      ...
      const headerParagraph =
        this.$i18n.locale === 'en'
          ...
          : 'Birazdan Form`a yönleneceksiniz.'
      const headerImage =
        this.$i18n.locale === 'en'
          ? '/images/mj2.png'
          : '/images/mj2.png'
